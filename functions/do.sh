...
declare -x -f viewGroupUsersAccessAll					#Вывод всех пользователей группы users. #$1 - может быть выведен дополнительно текст, предшествующий выводу списка пользователейviewGroupUsersAccessAll
                                ...
                                then
                                    #Группа "$4" существует
                                     case "$5" in
                                         ...
                                         sudo mkdir $2
                                         sudo useradd -N -g $4 -d $2/$1 -s $3 $1
                                         sudo chown $1:$4 $2
                                         sudo chmod 777 $2


                                         echo "$1:$6" | sudo -s chpasswd
                                        ...
                                        dbUpdateRecordToDb $WEBSERVER_DB users username $1 isAdminAccess 0 update
                                            ...
                                            case "$5" in
                                                ssh)
                                                    ...
                                                    sudo sed -i '$ a source $SCRIPTS/include/include.sh'  $2/.bashrc
